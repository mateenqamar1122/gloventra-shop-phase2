...
//                                         <td className="py-4 px-6">
//                                             <div className="flex items-center gap-2">
//                                                 <Button variant="ghost" size="sm" className="text-blue-600 hover:text-blue-700" onClick={() => openEditDialog(product)}>
//                                                     <Edit className="w-4 h-4" />
//                                                 </Button>
//                                                 <Button variant="ghost" size="sm" className="text-red-600 hover:text-red-700" onClick={() => { setSelectedProduct(product); setIsDeleteDialogOpen(true); }}>
